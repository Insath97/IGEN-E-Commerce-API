    ...
    public function productsGetAll(Request $request)
    {
        try {
            ...
            $query = Product::select([
                ...
                'compatibleProducts' => fn($q) => $q->select('products.id', 'products.name', 'products.primary_image_path', 'products.slug', 'products.is_active')->with(['variants:id,product_id,variant_name,price,sales_price,offer_price,is_offer,stock_quantity']),
                'bundledProducts' => fn($q) => $q->select('products.id', 'products.name', 'products.primary_image_path', 'products.slug', 'products.is_active')->with(['variants:id,product_id,variant_name,price,sales_price,offer_price,is_offer,stock_quantity']),
