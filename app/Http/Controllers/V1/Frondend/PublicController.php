    ...
    public function productsGetAll(Request $request)
    {
        try {
            ...
            $query = Product::select([
                ...
                'tags:id,name,slug',
                'compatibleProducts' => fn($q) => $q->select('id', 'name', 'primary_image_path', 'slug', 'is_active')->with(['variants:id,product_id,variant_name,price,sales_price,offer_price,is_offer,stock_quantity']),
                'bundledProducts' => fn($q) => $q->select('id', 'name', 'primary_image_path', 'slug', 'is_active')->with(['variants:id,product_id,variant_name,price,sales_price,offer_price,is_offer,stock_quantity']),
